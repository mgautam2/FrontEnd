...
function TermsWithRedux() {
  ...
  const termColumns = [
    ...
    { title: 'Start Date',
      ...
      render: rowData => renderDate(rowData.startDate),
      editComponent: props => editDate(props, true)
    },
    { title: 'End Date',
      field: 'endDate',
      validate: rowData => rowData.endDate !== undefined,
      render: rowData => renderDate(rowData.endDate),
      editComponent: props => editDate(props, false)
    },
    { title: 'University', 
      field: 'id',
      render: () => (
